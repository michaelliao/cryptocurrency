...
import com.itranswarp.cryptocurrency.common.IPv6Serializer;
import com.itranswarp.cryptocurrency.common.TimestampSerializer;

public class NetworkAddress {

	@JsonSerialize(using = TimestampSerializer.class)
	public long time; // uint32, the Time (version >= 31402). Not present in
						// version
						// message.
	public long services; // uint64, same service(s) listed in version
	@JsonSerialize(using = IPv6Serializer.class)
	public byte[] ipv6; // 16 bytes IPv6 address. Network byte order.
	// the IPv4 address is 12 bytes 00 00 00 00 00 00 00 00 00 00 FF FF,
	// followed by the 4 bytes of the IPv4 address
	public int port; // uint16, port number
